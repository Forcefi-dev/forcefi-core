...
contract ForcefiFactoryMain is SimpleForcefiFactory {
    ...
    function createMainWallet (string calldata _companyName, bool _isPrivate, uint _crosschainFee) public override payable returns(address){
...
//        }
    ...
    function deployFundraising(Vesting.FundraisingData memory _fundraisingData, address [] memory _attachedERC20Address, uint _attachedERC20AddressLength, address _referralAddress) internal override returns(address){
