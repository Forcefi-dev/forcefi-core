...
async function main() {
  ...
  console.log("ContractFactory contract address " + forcefiPackageAddress)
  ...
  await tx3.wait();
  console.log("Package address for Vesting: " + await Fundraising.getAddress() + " set to set to:", forcefiPackageAddress);
